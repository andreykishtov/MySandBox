...
function sketchBoard() {
  ...
  function creatShapeDiv(createShape) {
    ...
    if (createShape.style.borderRadius) {
  ...
  function movemorethan1(mousepoint) {
    ...
    moveElement(mousepoint, selected[0]);
    // moveElement(selected[0].target);
    //moveElement(selected[1]);
  }

  function moveElement(movemouse, selected) {
  ...
  function resize(eventmouse) {
    ...
    function resizeBigDiv(movemouse) {
      ...
      movemouse.preventDefault();
      if (movemouse.currentTarget.className == 'possition4') {
        //Right Down
        this.parentNode.style.height =
          movemouse.clientY - parseInt(this.parentNode.style.top) - parseInt(header['0'].scrollHeight) + 'px';
        this.parentNode.style.width = movemouse.clientX - parseInt(this.parentNode.style.left) + 'px';
      }
      if (movemouse.currentTarget.className == 'possition2') {
        //Left Down
        this.parentNode.style.height =
          movemouse.clientY - parseInt(this.parentNode.style.top) - parseInt(header['0'].scrollHeight) + 'px';
        this.parentNode.style.width =
          parseInt(this.parentNode.style.width) +
          parseInt(this.parentNode.style.left) -
          movemouse.clientX +
          'px';
        this.parentNode.style.left = movemouse.clientX + 'px';
      }
      if (movemouse.currentTarget.className == 'possition3') {
        //Right Up
        this.parentNode.style.width = movemouse.clientX - parseInt(this.parentNode.style.left) + 'px';
        this.parentNode.style.height =
          parseInt(this.parentNode.style.height) -
          movemouse.clientY +
          parseInt(this.parentNode.style.top) +
          parseInt(header['0'].scrollHeight) +
          'px';
        this.parentNode.style.top = movemouse.clientY - parseInt(header['0'].scrollHeight) + 'px';
      }
      if (movemouse.currentTarget.className == 'possition1') {
        //Left Up
        this.parentNode.style.height =
          parseInt(this.parentNode.style.height) -
          movemouse.clientY +
